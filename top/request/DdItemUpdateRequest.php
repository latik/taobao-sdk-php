<?php
/**
 * TOP API: taobao.dd.item.update request
 * 
 * @author auto create
 * @since 1.0, 2015-01-20 12:44:20
 */
class DdItemUpdateRequest
{
	/** 
	 * 业务标位字段，用来标示菜品的特定属性， 
isMust:必点菜品,
lessNum:有起售份数的菜品起售,单位unit字段的;值用|划分，前面是具体描述比如5份起售，|后面给我们具体的数值
isSale:特价菜
canSell:是否在点点上下单，比如海鲜类时价的菜品，需要店里称算的，只能看不能下单，默认是0（可以下单）
	...
	/** 
	 * 菜品状态；0或1：上架 ；-2：下架；如果不传，默认做上架状态，传入的话，则按照传入状态
	 **/
	private $status;
